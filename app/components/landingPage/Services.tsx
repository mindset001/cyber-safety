  ...
  return (
    <section className="py-16 bg-white text-center">
      <div className="w-[55%] mx-auto px-4">
        <h3 className="text-[#16B7D9] font-semibold text-[40px]">What We Do</h3>
      ...
      <div className="mt-10 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 bg-[#16B7D9] p-8 rounded-lg text-white">
