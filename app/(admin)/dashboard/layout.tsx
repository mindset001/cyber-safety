  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <aside className="w-64 bg-white shadow-md p-4 fixed h-full">
        ...
        <nav className="mt-6 space-y-4">
          <button
            ...
            className="block p-2 text-gray-700 hover:bg-gray-200 rounded w-full text-left"
          >
            Home
          </button>
          <button
          ...
          <a href="/login" className="block p-2 text-red-500 hover:bg-gray-200 rounded">
            Logout
          </a>
        </nav>
      </aside>
      ...
      <div className="flex-1 flex flex-col ml-64">
        {/* Header */}
        <header className="flex items-center justify-between bg-white shadow p-4 fixed w-[calc(100%-16rem)] top-0 z-10">
          {/* Search Bar */}
        ...
        <main className="p-6 overflow-y-auto mt-16 h-[calc(100vh-4rem)]">{children}</main>
      </div>
    </div>
  );
}
